...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="./asset/js-cssframework/glider.css">
    <link rel="stylesheet" href="./asset/font/fontawesome-free-6.2.0-web/css/all.min.css">
    <link rel="stylesheet" href="./asset/js-cssframework/bootstrap-5.0.2-dist/css/bootstrap-grid.css">
    <script src="./asset/js-cssframework/glider.js"></script>
    <script src="./asset/js-cssframework/Jquery/jquery-3.7.0.min.js"></script>
    <title>Meta</title>
                        ...
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/icon-dieuhoa.svg" alt="">
                                </div>
                                <div class="name-market">Điều hòa giá từ 4.6 triệu</div>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/quat-lam-mat.svg" alt="">
                                </div>
                                <div class="name-market">Quạt điện giá từ 299K</div>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/flash-sale.svg" alt="">
                                </div>
                                <div class="name-market">Flash Sale</div>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/giam-gia.svg" alt="">
                                </div>
                                <div class="name-market">Mã Freeship, Giảm giá</div>
                            </a>
                        </li>
                    </ul>
                    <ul class="row-cols-xl-4">
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/kplusvietnam.png" alt="">
                                </div>
                                <div class="name-market">Nhận voucher 100K</div>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/home-credit-a.svg" alt="">
                                </div>
                                <div class="name-market">Trả góp 0%, Giảm tới 500K*</div>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/kredivo-icon.svg" alt="">
                                </div>
                                <div class="name-market">Trả góp từ 0%, giảm tới 500K*</div>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <div class="icon-market">
                                    <img src="./asset/img/google-play-01.svg" alt="">
                                </div>
                                <div class="name-market">Tải App META trên Android</div>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <section>
        <div class="warp">
            <div class="hot-catalog">
                ...
                <div class="hot-catalog-container">
                    <ul>
                        <li>
                             <a href="">
                                <div class="discount">
                                ...
                                <div class="catalog-thumb">
                                    <span>
                                        <img src="./asset/img/c1018-210x210.jpg" alt="">
                                    </span>
                                </div>
                    ...
                    <ul>
                        <li>
                            <div class="flash-sale-product">
                                <div class="promo">
                                    <img src="./asset/img/tag-miennam-1x.png" alt="">
                                </div>
                                ...
                                <div class="thumb">
                                    <img src="./asset/img/tu-lanh-casper-2-cua-ngan-dong-tren-240l-rt-258vg-3.jpg" alt="">
                                </div>
                                ...
                                <div class="countdown">
                                    <div class="count-left">
                                        <strong>4.790.000đ</strong>
                                        <strike>6.050.000đ</strike>
                                    </div>
                                        ...
                                        <div class="flash-sale-box">
                                            ...
                                            <div class="time-flash running">
                                                <div class="time-box-first">
                                                    <span class="days">14</span> ngày
                                                </div>
                                            </div>

                                            <div class="time-left-counr">
                                                Còn <span class="days">10</span> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="warp">
            <div class="tag-catalog">
                ...
                <div class="tag-catalog-container">
                    <div class="tag-catalog-option">
                        <div class="tag-catalog-banner">
                            <img src="./asset/img/tivi-290x350.png" alt="">
                        </div>
                            ...
                            <ul>
                                <li>
                                    <a href="">
                                        <div class="tag-thumb">
                                            <span>  
                                                <img src="./asset/img/c1021-0x0.jpg" alt="">
                                            </span>
                                        </div>
                                        <div class="tag-title">Tủ mát</div>
                                    </a>
                                </li>
                ...
                <div class="trend-prod">
                    ...
                    <div class="trend-prod-container">
                        <ul>
                            <li>
                ...
                <div class="thuonghieu-container">
                    <ul class="thuonghieu-list">
                       <li class="thuonghieu-item">
                            ...
                            <a href="">
                                <img src="./asset/img/logo-nagakawa-nho.png" alt="">

                            </a>
                       </li>
                       <li class="thuonghieu-item">
                            <a href="">
                                <img src="./asset/img/logo-samsung-to.png" alt="">

                            </a>

                            <a href="">
                                <img src="./asset/img/logo-sunhouse-nho.png" alt="">

                            </a>
                       </li>
                       <li class="thuonghieu-item">
                            <a href="">
                                <img src="./asset/img/toshiba_n.jpg" alt="">

                            </a>

                            <a href="">
                                <img src="./asset/img/Makita-logo-35.png" alt="">

                            </a>
                       </li>
                       <li class="thuonghieu-item">
                            <a href="">
                                <img src="./asset/img/logo-senko-nho.png" alt="">

                            </a>

                            <a href="">
                                <img src="./asset/img/Tiross-Logo-35.png" alt="">

                            </a>
                       </li>
                       <li class="thuonghieu-item">
                            <a href="">
                                <img src="./asset/img/logo-lg-to.png" alt="">

                            </a>

                            <a href="">
                                <img src="./asset/img/logo-casper-to.png" alt="">

                            </a>
                       </li>
                       <li class="thuonghieu-item">
                            <a href="">
                                <img src="./asset/img/Panasonic-Logo-500.png" alt="">

                            </a>

                            <a href="">
                                <img src="./asset/img/Ecovacs-35.png" alt="">
                       ...
                       <li class="thuonghieu-item">
                            <a href="">
                                <img src="./asset/img/Sharp-Logo-500.png" alt="">
                            </a>

                            <a href="">
                                <img src="./asset/img/logo-vinawind-nho.png" alt="">
    ...
    <section>
        <div class="warp">
            <div class="support-service">
                <div class="support-service-head">
                    <div class="title">
                        <a href="">
                            Hỗ trợ & Dịch vụ
                        </a>
                    ...
                    <div class="service-container">
                        <ul class="service-list">
                            <li class="service-item">
                                <a href="">
                                    <img src="./asset/img/chinh-sach-doi-tra.jpg" alt="">
                                    <div class="service-name">Chính sách đổi trả</div>
                                </a>
                            </li>
                            <li class="service-item">
                                <a href="">
                                    <img src="./asset/img/kinh-nghiem-mua-sam.jpg" alt="">
                                    <div class="service-name">Tư vấn sử dụng</div>
                                </a>
                            </li>
                            <li class="service-item">
                                <a href="">
                                    <img src="./asset/img/huong-dan-mua-hang.jpg" alt="">
                                    <div class="service-name">Hướng dẫn mua hàng</div>
                                </a>
                            </li>
                            <li class="service-item">
                                <a href="">
                                    <img src="./asset/img/meo-vat-cuoc-song.jpg" alt="">
                                    <div class="service-name">Ẩm thực</div>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="support">
                    <ul class="support-list">
                        <li class="support-item">
                            <a href="">
                                <img src="./asset/img/tuoc-nang-quat-la-gi-al-size-80x50-znd.jpg" alt="">
                                <h3>Tuốc năng quạt là gì? Cấu tạo và phân loại túp năng quạt</h3>
                            </a>
                        </li>
                        <li class="support-item">
                            <a href="">
...
<!-- cam ket -->
    ...
    <footer>
                ...
                <div class="manage-content">
                    <div class="region">
                        ...
                        <div class="region-phone">
                            ...
                            <span class="phone">(024) 3568 6969</span>
                        </div>
                        <div class="region-phone">
                            <span class="title">Bảo hành:</span>
                            <span class="phone">(028) 38 333 222</span>
                        </div>
                    </div>
                    ...
                    <div class="region">
                        ...
                        <div class="region-phone">
                            <span class="title">Mua hàng:</span>
                            <span class="phone">(024) 3833 6666</span>
                        </div>
                        <div class="region-phone">
                            <span class="title">Bảo hành:</span>
                            <span class="phone">(028) 38 333 222</span>
        ...
        <div class="info">
            <div class="info-comp">
                <h2>CÔNG TY CỔ PHẦN MẠNG TRỰC TUYẾN META</h2>
                <p>Trên 16 năm Uy tín cung cấp Dịch vụ Bán hàng & Thu tiền tại nhà toàn quốc</p>
                <p>Giấy chứng nhận ĐKDN số <i style="font-style: normal; font-weight: 700;">0102196915</i> do Sở KH&ĐT TP. Hà Nội cấp ngày 29/03/2007.</p>
            </div>
        ...
        <div class="contract">
            <div class="address">
                <div class="address-city hn">
                    <div class="address-text">
                        <strong>Hà Nội:</strong>
                        56 Duy Tân, P. Dịch Vọng Hậu, Q. Cầu Giấy, Hà Nội
                    </div>

                    <div class="phone-city">
                        <strong>- Điện thoại:</strong>
                        <a href=""> (024) 3568 6969</a>
                    </div>
                </div>
                ...
                <div class="address-city hn">
                    <div class="address-text">
                        ...
                        Số 716-718 Điện Biên Phủ, Phường 10, Quận 10
                    </div>

                    <div class="phone-city">
                        <strong>- Điện thoại:</strong>
                        <a href=""> (028) 3833 6666</a>
                    </div>
                </div>
            </div>
